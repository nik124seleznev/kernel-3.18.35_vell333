...
extern void GT9761AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9761AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9761AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_GT9762SAF_SUPPORT
#define GT9762SAF_SetI2Cclient GT9762SAF_SetI2Cclient_Main
#define GT9762SAF_Ioctl GT9762SAF_Ioctl_Main
#define GT9762SAF_Release GT9762SAF_Release_Main
extern void GT9762SAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long GT9762SAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9762SAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_WV517SAF_SUPPORT
#define WV517SAF_SetI2Cclient WV517SAF_SetI2Cclient_Main
#define WV517SAF_Ioctl WV517SAF_Ioctl_Main
#define WV517SAF_Release WV517SAF_Release_Main
extern void WV517SAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long WV517SAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
